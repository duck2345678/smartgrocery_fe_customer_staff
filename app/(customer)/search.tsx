...
export default function CustomerSearch() {
    ...
    ({ item }: { item: Product }) => {
      ...
      return (
        <Pressable
          ...
          className="mb-3 bg-white border border-slate-100 rounded-2xl overflow-hidden flex-row"
          style={{ height: 120 }}
        >
          ...
          <View className="flex-1 p-3 justify-between">
            <View>
              ...
              <Text className="text-xs text-slate-500 font-inter mt-0.5">{item.category}</Text>
            </View>
  ...
  return (
    <View className="flex-1 bg-background">
      {/* Search Header */}
      <View className="px-4 pt-6 pb-3 bg-white border-b border-slate-100">
        <View className="flex-row items-center gap-x-3">
          <Pressable onPress={() => router.back()} hitSlop={12} className="p-1">
            <ArrowLeft size={22} color="#475569" />
          </Pressable>

          <View className="flex-1 flex-row items-center bg-slate-100 rounded-2xl px-4 py-3">
            ...
            <TextInput
              ...
              className="flex-1 ml-2 text-base font-inter text-slate-900"
      ...
      <View className="flex-1 px-4 pt-4">
        {!showResults ? (
          ...
          <View className="flex-1 items-center justify-center">
            ...
            <Text className="text-slate-400 font-inter mt-4 text-center">
          ...
          <View className="flex-1 items-center justify-center">
            ...
            <Text className="text-slate-400 font-inter mt-4">Đang tìm kiếm...</Text>
          </View>
        ) : searchQuery.isError ? (
          /* Error with retry */
          <View className="flex-1 items-center justify-center">
          ...
          /* No results */
          <View className="flex-1 items-center justify-center">
            <Text className="text-slate-400 font-inter text-center">
          ...
          /* Results list */
          <>
            <Text className="text-sm font-inter text-slate-500 mb-3">
