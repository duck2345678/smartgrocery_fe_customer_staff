      ...
      <View className="px-6 py-4 flex-row items-center justify-between border-b border-[#F1F5F9] bg-white">
        <View className="flex-row items-center">
          ...
          <View className="ml-4">
            ...
            <Text className="text-[11px] font-inter text-slate-400">Khu vực làm việc</Text>
          </View>
        </View>
          ...
          >
            {markAllReadMutation.isPending ? (
              ...
              <>
                ...
                <Text className="text-[12px] font-outfit-bold text-[#16A34A] ml-1.5">Đọc tất cả</Text>
              </>
            )}
          </Pressable>
        )}
        ...
        <View className="flex-1 items-center justify-center px-8 py-20">
          ...
          <Text className="text-[13px] font-inter text-slate-400 text-center mt-2.5 px-6 leading-5">
            {activeTab === 'unread' 
              ...
              : 'Bạn chưa có thông báo nào. Các cập nhật mới về đơn hàng hoặc chấm công sẽ hiển thị tại đây.'}
          </Text>
        </View>
      ) : (
              ...
              return (
                ...
                >
                  <View 
                    ...
                    style={{
                      shadowColor: item.isRead ? '#000' : '#16A34A',
                    ...
                    <View className="flex-row items-start">
                      ...
                      <View className="flex-1">
                        <View className="flex-row items-start justify-between">
                          <Text 
                            className={`flex-1 text-[14px] leading-5 text-slate-800 ${
                              !item.isRead ? 'font-outfit-bold text-[#15803D]' : 'font-inter-bold'
                            }`}
                          >
                            {item.title}
                          </Text>
                        ...
                        <View className="flex-row items-center justify-between mt-2.5">
                          ...
                          {!item.isRead && (
                            <Text className="text-[10px] font-outfit-bold text-[#16A34A] uppercase tracking-wider">Mới</Text>
                          )}
                        </View>
                      </View>
                    </View>
