      ...
      <View className="px-6 pt-6 pb-3 flex-row items-center justify-between">
        ...
        >
          ...
          <View className="flex-row items-center">
            ...
            <Text className="ml-2 text-xs font-inter-bold text-muted">Giao đến</Text>
          ...
          {isLoading ? (
            ...
            <Text className="mt-1 text-base font-outfit-bold text-text" numberOfLines={1}>
              {addressLine}
            </Text>
          )}
        </Pressable>
                ...
                <View className="gap-y-3">
                  {addresses.map((a) => {
                    ...
                    return (
                      ...
                      >
                        <Card className={`p-4 border ${active ? 'border-primary bg-surface' : 'border-border bg-surface'}`}>
